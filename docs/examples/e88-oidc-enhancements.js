/**
 * Example 88: OIDC Enhancements Showcase
 *
 * Demonstrates all of the latest OIDC enhancements:
 ...
 *   2. pnpm exec node docs/examples/e88-oidc-enhancements.js
...
async function main() {
  ...
  // 2. Configure API Plugin with every OIDC enhancement
      ...
      drivers: [
        {
          ...
          config: {
            ...
            // ✅ Implicit token refresh (Default: enabled!)
    ...
    routes: {
      ...
      'GET /': async (c) => {
        ...
        return c.html(`
          ...
          <html>
            <head>
              <title>OIDC Enhancements Demo</title>
              <style>
                body {
              ...
              <div class="card">
                <div class="user-header">
                  ...
                  <div>
                    ...
                    <p>Your session is protected with the enhanced OIDC stack</p>
                  </div>
                </div>
  ...
  // ========================================
  console.log('\n' + '='.repeat(80));
  console.log('🚀 OIDC Enhancements Demo Server');
  console.log('='.repeat(80));
  console.log('\n📖 Open in browser:');
  console.log('   👉 http://localhost:3000\n');
  console.log('✨ Latest Enhancements:');
