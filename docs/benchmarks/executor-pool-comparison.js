/**
 * Benchmark: ExecutorPool vs Current Implementation
 *
 * Compares 10,000 write operations using:
 * 1. Current s3db.js implementation (no global concurrency control)
 * 2. New ExecutorPool implementation (global concurrency control)
 *
 * Usage:
 *   node benchmarks/executor-pool-comparison.js
 */

import { Database } from '../src/database.class.js'
import { ExecutorPool } from '../src/concerns/executor-pool.js'
...
const CONCURRENCY = 50 // ExecutorPool concurrency
...
// Benchmark 1: Current Implementation (without ExecutorPool)
async function benchmarkCurrent() {
  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
  console.log('📊 Benchmark 1: Current Implementation (No ExecutorPool)')
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')
...
// Benchmark 2: With ExecutorPool
async function benchmarkWithPool() {
  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
  console.log('📊 Benchmark 2: With ExecutorPool (Concurrency: ' + CONCURRENCY + ')')
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')
  ...
  // Benchmark
  const bench = new Benchmark('With ExecutorPool')
  const startTime = Date.now()
  let completed = 0
...
function printComparison(current, withPool) {
  ...
  if (improvements >= 3) {
    console.log('✅ ExecutorPool shows significant improvements!')
  } else if (improvements >= 2) {
    console.log('⚠️  ExecutorPool shows mixed results')
  } else {
...
async function main() {
  console.log('\n' + '='.repeat(60))
  console.log('🔬 s3db.js ExecutorPool Benchmark')
