...
export class CookieFarmSuitePlugin extends Plugin {
    ...
    pluginFactories;
    dependencies;
    jobsResource; // Placeholder for Resource instance
    puppeteerPlugin;
    cookieFarmPlugin;
    queuePlugin;
    ttlPlugin;
    ...
    constructor(options = {}) {
        ...
        const jobsResource = options.jobsResource ||
    ...
    async onInstall() {
        ...
        this.puppeteerPlugin = (await this._installDependency('puppeteer', this.pluginFactories.puppeteer({
            namespace: this.namespace,
            ...this.config.puppeteer
        })));
        this.cookieFarmPlugin = (await this._installDependency('cookie-farm', this.pluginFactories.cookieFarm({
            namespace: this.namespace,
    ...
    async startProcessing(options = {}) {
        if (!this.jobsResource?.startProcessing)
            return;
...
//# sourceMappingURL=cookie-farm-suite.plugin.js.map