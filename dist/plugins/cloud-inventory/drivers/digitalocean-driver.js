...
export class DigitalOceanInventoryDriver extends BaseCloudDriver {
    ...
    async _initializeClient() {
        ...
        this._apiToken = credentials.token || credentials.apiToken || process.env.DIGITALOCEAN_TOKEN || null;
        if (!this._apiToken) {
...
//# sourceMappingURL=digitalocean-driver.js.map