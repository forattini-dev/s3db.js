...
export declare function handleUpdate({ resource, data, mappedData, originalData }: BehaviorHandleUpdateParams): Promise<BehaviorResult>;
...
//# sourceMappingURL=truncate-data.d.ts.map