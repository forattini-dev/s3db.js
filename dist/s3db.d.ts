...
declare function getLogger(name: string, options?: Omit<LoggerOptions, 'name'>): S3DBLogger;
...
type IdGeneratorFunction = ((data?: unknown) => string) | ((data?: unknown) => Promise<string>);
