...
export function exportToTerraformState(snapshots, options = {}) {
    const { terraformVersion = '1.5.0', lineage = generateLineage(), serial = 1, outputs = {}, resourceTypes = [], providers = [] } = options;
    let filteredSnapshots = snapshots;
    if (resourceTypes.length > 0) {
        filteredSnapshots = filteredSnapshots.filter(s => resourceTypes.includes(s.resourceType));
    }
...
//# sourceMappingURL=terraform-exporter.js.map