...
export class SecurityAnalyzer {
    ...
    static checkDependencies(_results, summary) {
        const check = {
            id: 'C',
            name: 'Dependencies',
    ...
    static checkAuth(_results, summary) {
        const check = {
            id: 'F',
            name: 'Authentication',
    ...
    static calculateScoreAndGrade(audit) {
        ...
        if (audit.summary.score >= 90)
            audit.summary.grade = 'A';
        else if (audit.summary.score >= 80)
            audit.summary.grade = 'B';
        else if (audit.summary.score >= 70)
            audit.summary.grade = 'C';
        else if (audit.summary.score >= 60)
            audit.summary.grade = 'D';
        else
            audit.summary.grade = 'F';
    }
