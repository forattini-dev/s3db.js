...
describe('MemoryClient - Compatibility with Real Client', () => {
  ...
  // Skip: ValidatorManager is a singleton, passphrase from first initialization is preserved
  // This test fails when other tests create ValidatorManager without passphrase first
  it.skip('should work with encryption (secret fields)', async () => {
...
describe('MemoryClient - Performance', () => {
  ...
  it('should handle bulk inserts efficiently', async () => {
    ...
    // Should be reasonably fast (under 3 seconds for 100 inserts in container/CI)
