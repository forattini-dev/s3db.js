...
export function createRedactRules(customPatterns: RegExp[] = []): string[] {
...
export function isSensitiveField(fieldName: string, customPatterns: RegExp[] = []): boolean {
...
export function createPayloadRedactionSerializer(maxBytes: number = 1_000_000): (value: unknown) => unknown {
...
export function createSensitiveDataSerializer(customPatterns: RegExp[] = []): (data: unknown) => unknown {
