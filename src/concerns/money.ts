 ...
 */
export function encodeMoney(value: number | null | undefined, currency = 'USD'): string | null | undefined {
  if (value === null || value === undefined) return value;
  if (typeof value !== 'number' || isNaN(value)) return value as unknown as undefined;
  if (!isFinite(value)) return value as unknown as undefined;
 ...
 */
export function decodeMoney(encoded: string | unknown, currency = 'USD'): number | unknown {
