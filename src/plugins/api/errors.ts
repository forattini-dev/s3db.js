...
class HttpError extends Error {
  ...
  constructor(message: string, code: string, status: number, details: ErrorDetails | null = null) {
    super(message);
...
export class HttpBadRequestError extends HttpError {
  constructor(message: string = 'Bad request', details: ErrorDetails | null = null) {
...
export class HttpUnauthorizedError extends HttpError {
  constructor(message: string = 'Unauthorized', details: ErrorDetails | null = null) {
...
export class HttpForbiddenError extends HttpError {
  constructor(message: string = 'Forbidden', details: ErrorDetails | null = null) {
...
export class HttpNotFoundError extends HttpError {
  constructor(message: string = 'Not found', details: ErrorDetails | null = null) {
...
export class HttpMethodNotAllowedError extends HttpError {
  constructor(message: string = 'Method not allowed', details: ErrorDetails | null = null) {
...
export class HttpConflictError extends HttpError {
  constructor(message: string = 'Conflict', details: ErrorDetails | null = null) {
...
export class HttpUnprocessableEntityError extends HttpError {
  constructor(message: string = 'Unprocessable entity', details: ErrorDetails | null = null) {
...
export class HttpTooManyRequestsError extends HttpError {
  constructor(message: string = 'Too many requests', details: ErrorDetails | null = null) {
...
export class HttpInternalServerError extends HttpError {
  constructor(message: string = 'Internal server error', details: ErrorDetails | null = null) {
...
export class HttpNotImplementedError extends HttpError {
  constructor(message: string = 'Not implemented', details: ErrorDetails | null = null) {
...
export class HttpServiceUnavailableError extends HttpError {
  constructor(message: string = 'Service unavailable', details: ErrorDetails | null = null) {
...
type HttpErrorConstructor = new (message?: string, details?: ErrorDetails | null) => HttpError;

/**
 * Create error by HTTP status code
 */
export function createHttpError(status: number, message: string, details: ErrorDetails | null = null): HttpError {
  const errorMap: Record<number, HttpErrorConstructor> = {
