...
export function validateAccessToken(accessToken: string, _config: OidcConfig): SimpleValidationResult {
...
export function validateRefreshToken(refreshToken: string, _config: OidcConfig): SimpleValidationResult {
...
export function validateTokenResponse(tokenResponse: TokenResponse, config: OidcConfig): ValidationResult {
  const errors: string[] = [];
...
export function validateUserinfo(userinfo: UserinfoResponse, idTokenClaims: IdTokenClaims): ValidationResult {
  const errors: string[] = [];
...
export function getUserFriendlyError(errors: string[] | null, _context: string = 'authentication'): string {
...
export function validateConfig(config: OidcConfig): ValidationResult {
  const errors: string[] = [];
