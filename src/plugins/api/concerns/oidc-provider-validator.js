 ...
 * Inspired by Auth0's express-openid-connect provider validation.
 *
 * @module api/concerns/oidc-provider-validator
 */
...
export function validateProviderCompatibility(discoveryDoc, config) {
  ...
  // 6. Token Endpoint (required for code flow)
  ...
  // 7. Authorization Endpoint (always required)
  ...
  // 12. Token Endpoint Auth Methods
...
/**
 * Log provider compatibility issues
 *
 * @param {Object} result - Result from validateProviderCompatibility
