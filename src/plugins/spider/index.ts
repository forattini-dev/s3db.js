...
export type {
  ...
  SEOScore,
  AssetsAnalysis,
  AnalysisResult as SEOAnalysisResult
...
export type {
  ...
  DiscoveredFeed,
  DiscoveredAPI,
  DiscoveredStaticFile,
  RobotsDirectives,
  CrawlerCompatibility,
  DiscoveryStats as DeepDiscoveryStats,
  CrawlBudget,
  DiscoveryReport
} from './deep-discovery.js';

export {
  analyzeIFrames,
  detectTrackingPixels,
  setLogger as setContentAnalyzerLogger
} from './content-analyzer.js';
export type {
  IFrameData,
  CategorizedIFrames,
  IFrameAnalysisResult,
  TrackingPixel,
  TrackingAttribute,
  TrackingPixelResult
} from './content-analyzer.js';
...
export {
  ...
  extractIndexedDB,
  analyzeAllStorage,
  setLogger as setStorageAnalyzerLogger
} from './storage-analyzer.js';
export type {
  StorageResult,
  IndexedDBResult,
  AllStorageResult
