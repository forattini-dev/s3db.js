...
export interface AuthConfig {
  ...
  required?: boolean;
  jwt?: { enabled?: boolean; secret?: string; issuer?: string; audience?: string; jwksUri?: string };
  apiKey?: { enabled?: boolean; keys?: Record<string, any>; header?: string; queryParam?: string };
}
 ...
 */
export function normalizeAuthConfig(authConfig: AuthConfig | undefined, logger: any): AuthConfig {
  if (!authConfig) {
    return {
      drivers: [],
      required: false
 ...
 * @private
 */
function normalizeDriver(driver: AuthDriverConfig, logger: any): AuthDriverConfig | null {
