...
import type {
  ...
  IdentitySecurityConfig as SecurityConfig,
  IdentityLoggingConfig as LoggingConfig,
  OnboardingOptions,
  SessionOptions,
  ...
  EmailConfig,
  MFAConfig,
  IdentityAuditConfig as AuditConfig,
  AccountLockoutConfig,
  GeoConfig,
  FailbanEndpoints,
  IdentityFailbanConfig as FailbanConfig,
  RateLimitEndpoint,
  IdentityRateLimitConfig as RateLimitConfig,
  PKCEConfig,
  FeaturesConfig,
  InternalResourceDescriptor,
  InternalResourceDescriptors,
