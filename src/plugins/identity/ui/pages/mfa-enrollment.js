...
/**
 * Render MFA enrollment page
 * @param {Object} props - Page properties
 * @param {string} props.qrCodeDataUrl - QR code as data URL
 * @param {string} props.secret - TOTP secret (Base32)
 * @param {Array<string>} props.backupCodes - Array of backup codes
 * @param {Object} [props.config] - UI configuration
 * @returns {string} HTML string
 */
export function MFAEnrollmentPage(props = {}) {
