...
// Import driver classes directly (no circular dependency since multi-backup uses this file)
import FilesystemBackupDriver from './filesystem-backup-driver.class.js';
import S3BackupDriver from './s3-backup-driver.class.js';

/**
 * Available backup drivers (without multi to avoid circular dependency)
 */
...
/**
 * Available backup driver names
 */
export const BACKUP_DRIVERS = {
  filesystem: FilesystemBackupDriver,
  s3: S3BackupDriver,
  multi: null // Will be set by index.js to avoid circular dependency
};
