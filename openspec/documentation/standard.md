...
**Strict Rule:** All plugins must have their own directory in `docs/plugins/<plugin-name>/`. Single markdown files (e.g., `cache.md`) are **not permitted**.

Even simple plugins must follow this structure to ensure consistency and future scalability.

```
docs/plugins/my-plugin/
├── README.md                 # Entry point + Index + TLDR
...
**Why this structure?**
- 🎯 **Consistency**: Users navigate every plugin exactly the same way.
- 📉 **Cognitive Load**: READMEs stay lightweight and focused on "What is this?".
- 🔍 **Searchability**: Specific topics have their own URL/page.
...
## 2️⃣ Guides Organization & Usage Journey

### The "Usage Journey" Pattern (Recommended)

For complex plugins, structure your guides as a progressive journey rather than just a flat list. This helps users learn incrementally.

**Example Structure:**
- **Level 1:** Basic Usage (The "Hello World")
- **Level 2:** Adding Configuration (Common options)
- **Level 3:** Feature A (Intermediate)
- **Level 4:** Feature B (Advanced)
- **Level 5:** Production Setup (Performance, Monitoring)

### Advanced Documentation Index

For plugins with many features, a simple table of contents isn't enough. Use a multi-dimensional index in your README.
...
### By Experience Level
- **Beginner**: [Quickstart](#-quickstart) → [Level 1](#level-1)
- **Intermediate**: [Configuration](#-configuration) → [Best Practices](#-best-practices)
- **Advanced**: [Architecture](./guides/architecture.md) → [Deep Dive](./guides/deep-dive.md)
