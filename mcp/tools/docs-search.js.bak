 ...
 * @param {string} type - 'core' or 'plugins'
...
export function createDocsSearchHandlers(server) {
  return {
    ...
    async s3dbListCoreTopics() {
      return listTopics(EMBEDDING_TYPES.CORE);
    },

    async s3dbListPluginTopics() {
